      ...
      <div className="otp">
        ...
        <Grid>
          ...
          <div className="sidebar-header">
            <div className="logo-neom">
                <a href="http://localhost:9966/"><img src="../logo.svg"></img></a>
            </div>
            
            <div className="text-sidebar-header">
              <div className="light">NEOM MOBILITY</div>
              <div className="bold">SIMULATION PLATFORM</div>
              </div>
          </div>
        ...
        <div className="footer-button-container">
          ...
          <div className='button-back'>
              <a href="javascript:history.back()"><img src="../back.svg"></img></a>
              <div className='text-footer-button-container'>BACK</div>
          </div>
          <div className='button-restart'>
            <a href="http://localhost:9966/"><img src="../restart.svg"></img></a>
            <div className='text-footer-button-container'>RESTART</div>
          </div>
        </div>

          <div className='button-exit'>
            <a href="http://localhost:9980/"><img src="../exit.svg"></img></a>
            <div className='text-footer-button-container'>EXIT</div>
        </div>
